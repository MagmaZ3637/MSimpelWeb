...
<div class="">
    <div class="px-4 py-5 my-5 text-center">
        ...
        <div class="col-lg-6 mx-auto">
            <p class="lead mb-4">Disini memiliki system grade yang digerakkan js dan login digerakkan oleh php session. Web Ini Dibuat Oleh MagmaZ3637 | Zidan Alfa Permana</p>
